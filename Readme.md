...
The examples for a Vehicle ECU software and a Hardware-in-the-Loop simulation setup has been developed in close collaboration with Speedgoat GmbH. We want especially to acknowledge the work done by
* Timo Strässle
